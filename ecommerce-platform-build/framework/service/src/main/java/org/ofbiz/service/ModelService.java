    ...
    */
    ...
    public Types getTypes(Document document, Definition def) {
       ...
       // eepkElement1.setTextContent("The name of element need to be appended with name of entity such as eepk-Product for Product entity.");
        eepkElement1.setNodeValue( "The name of element need to be appended with name of entity such as eepk-Product for Product entity." );
        ...
        cusObjElement1.setNodeValue( "Object content is hex encoded so does not need to be in a CDATA block." );
